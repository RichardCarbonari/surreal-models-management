        ...
        <div className={styles.content}>
          ...
          <div className={styles.formWrap}>
            ...
            <div className={styles.form}>
              ...
              <div className={styles.formGroup}><label className={styles.label}>Sobre você</label><textarea className={styles.textarea} placeholder="Conte sobre você..." rows={4}></textarea></div>
